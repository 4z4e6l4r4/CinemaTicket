...
namespace CinemaTicket.Migrations
{
    ...
    [Migration("20240125074156_createDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaTicket.Models.Pay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaTicket.Models.Sahne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaTicket.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaTicket.Models.Pay", b =>
                {
                    b.HasOne("CinemaTicket.Models.Ticket", "Ticket")
                        .WithOne("Pay")
                        .HasForeignKey("CinemaTicket.Models.Pay", "TicketId")
            ...
            modelBuilder.Entity("CinemaTicket.Models.Screening", b =>
                {
                    ...
                    b.HasOne("CinemaTicket.Models.Sahne", "Sahne")
                        .WithMany("Screenings")
                        .HasForeignKey("SahneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CinemaTicket.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("CinemaTicket.Models.User", "User")
                        .WithMany("Tickets")
